...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master harish"<<endl;
        string phrase = "Good Morning Master harish";
        ...
        cout<< "Good Afternoon Master harish"<<endl;
        string phrase = "Good Afternoon Master harish";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master harish"<<endl;
        string phrase = "Good Evening Master harish";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER harish|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER harish";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="harish")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master harish...."<<endl<<endl;

                string phrase = "How can i help you Master harish";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master harish....."<<endl;
                    string phrase = "Hello Master harish";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master harish !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master harish !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                	    ...
                	    const char *charCommand = command.c_str();
              			system(charCommand);
						CreateProcess(TEXT("C:\\Users\\mypc\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
				}
...
//                }
                ...
                else if(command=="play music")
                {
                	...
                	const char *charCommand = command.c_str();
                	system(charCommand);
               	 	CreateProcess(TEXT("F:\\all_programs\\c++\\jarvis in c++\\despacito_justin_bieber.mp3"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                {
                    cout<<"Good Bye Master harish, see you soon!"<<endl;
                    string phrase = "Good Bye Master harish, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
